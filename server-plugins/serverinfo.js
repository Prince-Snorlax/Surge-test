...
exports.commands = {
	...
	credits: function (user, target, room) {
		...
		let popup = "<font size=5 color=#F7189F><u><strong>" + Config.serverName + " Credits:</strong></u></font><br />" +
			...
			"- " + Server.nameColor('Prince Sky', true) + " (Owner, Sysadmin, CSS, Host, Developer)<br />" +
			...
			"- " + Server.nameColor('Snorlax The Rain', true) + " (Manager)<br />" +
			"- " + Server.nameColor('Pokemon 1920', true) + " (Manager)<br />" +
			"- " + Server.nameColor('HoeenHero', true) + " (Developer)<br />" +
			"- " + Server.nameColor('A Helpful Rayquaza', true) + " (Bot)<br />" +
			"<br />" +
			"<u><strong>Retired Staff:</strong></u><br />" +
			"- " + Server.nameColor('Princess Qtie', true) + " (Former Sysadmin, Developer)<br />" + 
			"- " + Server.nameColor('Kevin Neo Ryan', true) + " (Former Sysadmin, Developer)" +
			"<br />" +
	...
	customcommands: function (room, user) {
		...
		this.sendReplyBox(
			...
			'<li><button class="button" name="send" value="/shellgame help">Shell Game</button></li><br />' +
